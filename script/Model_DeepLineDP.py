...
class HierarchicalAttentionNetwork(nn.Module):
    ...
    def forward(self, line_tensor):
        ...
        line_embeddings, word_att_weights, sent_att_weights, sents = self.sent_attention(line_tensor, line_lengths)
...
class SentenceAttention(nn.Module):
    ...
    def __init__(self, vocab_size, embed_dim, word_gru_hidden_dim, sent_gru_hidden_dim,
        ...
        self.lstm = nn.LSTM(2 * word_gru_hidden_dim, sent_gru_hidden_dim, num_layers=sent_gru_num_layers,
                            batch_first=True, bidirectional=True, dropout=dropout)

        # self.gat = GAT(2 * word_gru_hidden_dim, 2 * sent_gru_hidden_dim, dropout)
    ...
    def forward(self, line_tensor, line_lengths):
        ...
        unsqueeze_sents = sents.unsqueeze(1)
        packed_sents, _ = self.gru(unsqueeze_sents)
        packed_sents = packed_sents.squeeze(1)
