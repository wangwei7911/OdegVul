...
class SentenceAttention(nn.Module):
    ...
    def __init__(self, vocab_size, embed_dim, word_gru_hidden_dim, sent_gru_hidden_dim,
        ...
        self.gcn = GCN(2 * word_gru_hidden_dim, 2 * sent_gru_hidden_dim, dropout)
    ...
    def forward(self, line_tensor, line_lengths, adj):
        ...
        packed_sents = self.gcn(sents,adj)
...
class GCN(nn.Module):
    def __init__(self, line_embed_dim, hid_dim, dropout):
        super().__init__()
        self.conv1 = GCNConv(line_embed_dim, hid_dim)
        self.conv2 = GCNConv(hid_dim, hid_dim)
        self.conv3 = GCNConv(hid_dim, hid_dim)
        self.conv4 = GCNConv(hid_dim, hid_dim)
        self.conv5 = GCNConv(hid_dim, hid_dim)
        self.dropout = dropout
